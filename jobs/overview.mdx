...
- **Automatic Git Access**: Simply add the public SSH key from the [settings page](https://app.komodoai.dev/settings) to your Github/Gitlab account, and all your jobs will have access to pull your private repos
