...
- **Automatic Git Access**: Simply add the public SSH key from the [settings page](https://app.komodo.io/settings) to your Github/Gitlab account, and all your machines will have access to pull your private repos
