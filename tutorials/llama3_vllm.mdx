...
Create a configuration file for the Llama3 service. Below is a sample `service-llama3-aws.yaml` file.
...
```bash
komo service launch service-llama3-aws.yaml --name llama3-8b
```
