...
resources:
  # The cloud to use (optional). If not specified, Komodo will select the best cloud for your task
  # based on GPU availability and pricing.
  cloud: aws
...
# Start a Jupyter notebook on the machine (default is False)
notebook: true
